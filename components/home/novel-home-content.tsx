...
export function NovelHomeContent({ filters }: NovelHomeContentProps) {
  return (
    <main className="relative overflow-hidden">
      ...
      <section className="mx-auto flex min-h-screen w-full max-w-[1500px] flex-col px-4 pb-16 pt-4 sm:px-6 sm:pt-6 lg:px-8">
        <h1 className="sr-only">DinoNovel - อ่านนิยายออนไลน์ฟรี นิยายแปล นิยายแชท นิยายรัก อัปเดตใหม่ทุกวัน</h1>
        <SiteHeader />
